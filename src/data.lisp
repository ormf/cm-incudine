...
;;; generated by scheme->cltl from data.scm on 19-Mar-2009 14:43:22
...
(defparameter *logical-amplitudes*
  '((niente :niente) 0 (pppp :pppp) 1/10 (ppp :ppp) 1/5 (pp :pp) 3/10
    (p :p) 2/5 (mp :mp) 1/2 (mf :mf) 3/5 (f :f) 7/10 (ff :ff) 4/5
    (fff :fff) 9/10 (ffff :ffff) 1))
...
(defmethod amplitude
           (amp &optional (softest *softest*) (loudest *loudest*)
            (power *power*))
