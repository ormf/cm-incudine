...
;;; generated by scheme->cltl from midi2.scm on 19-Mar-2009 14:43:22
    ...
    (cond
     ((member os '(darwin osx macos macosx))
      (cond
       ...
       ((probe-file "/usr/local/bin/qtplay") "/usr/local/bin/qtplay")
       (t "open")))
     ((member os '(unix linux cygwin)) "timidity")
